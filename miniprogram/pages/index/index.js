...
Page({
  ...
  onLoad: function() {
    ...
    // 获取用户信息 开发者可以使用 wx.getSetting 获取用户当前的授权状态。
    // wx.getSetting({
    //   success: res => {
